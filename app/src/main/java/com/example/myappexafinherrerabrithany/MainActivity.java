package com.example.myappexafinherrerabrithany;
...
import com.example.myappexafinherrerabrithany.ml.ModelHerreraEx;
...
public class MainActivity extends AppCompatActivity implements OnSuccessListener<Text>, OnFailureListener {
    ...
    public void PersonalizedModel(View v){
        try {
            ...
            String[] etiquetas = {"LABORATORIO ACUICULTURA" ,"1 AUDITORIO" , "2 BAÑOS" ,"3 CENTRO MÉDICO" ,
                    "4 COMEDOR" ,"5 FCIP" , "6 FCI" ,"7 LABORATORIO AGROINDUSTRIAL" , "8 LABORATORIO SUELOS" ,
                    "9 LABORATORIO INDUSTRIAL" ,  "10 PARQUEADERO" ,   "11 FCAYF" ,  "12 BIBLIOTECA" ,
                    "13 POLIDEPORTIVO"};

            ModelHerreraEx model = ModelHerreraEx.newInstance(getApplicationContext());
            TensorBuffer inputFeature0 = TensorBuffer.createFixedSize(new int[]{1, 224, 224, 3}, DataType.FLOAT32);
            inputFeature0.loadBuffer(convertirImagenATensorBuffer(mSelectedImage));

            ModelHerreraEx.Outputs outputs = model.process(inputFeature0);
